...
text="gedit libreoffice-still zathura gedit-plugins zathura-pdf-mupdf cherrytree vym ttf-font-awesome ttf-inconsolata gnu-free-fonts"
...
32bit="lib32-alsa-lib lib32-alsa-plugins lib32-libpulse lib32-libcups lib32-wavpack lib32-celt lib32-twolame lib32-opus lib32-libvorbis lib32-speex lib32-speexdsp lib32-flac lib32-libwebp lib32-libdv lib32-libtheora lib32-libvpx lib32-libnm lib32-glu lib32-mesa lib32-openal"

user_programs="$general_programs $internet $storage $utilities $text $misc $libraries $codecs $browser_addons $32bit"
