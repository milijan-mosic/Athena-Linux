...
storage="android-file-transfer ark borg bleachbit gparted k3b nautilus gnome-disk-utility keepassxc"
...
optionals="plasma-nm gst-libav gst-plugins-bad gst-plugins-ugly qt5-imageformats kamera kimageformats kipi-plugins libcanberra "
...
user_programs="$general_programs $internet $storage $utilities $text $misc $optionals $libraries $codecs" # $browser_addons


sudo pacman -S $user_programs --noconfirm

# stigo sam do Firefox