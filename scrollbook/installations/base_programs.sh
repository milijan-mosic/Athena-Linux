...
general_programs="plasma-desktop spectacle strawberry gwenview vlc blueberry ksysguard gnome-calculator kronometer"
internet="youtube-dl thunderbird firefox transmission-gtk kdeconnect"
...
libraries="icedtea-web webkit2gtk cdrdao cdrtools dvd+rw-tools pacman-contrib mtpfs udiskie blueman bluez-tools bluez-utils cups cups-pdf neofetch pulseaudio-bluetooth"
